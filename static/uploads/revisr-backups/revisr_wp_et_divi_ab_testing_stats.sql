...
LOCK TABLES `wp_et_divi_ab_testing_stats` WRITE;
/*!40000 ALTER TABLE `wp_et_divi_ab_testing_stats` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_et_divi_ab_testing_stats` ENABLE KEYS */;
UNLOCK TABLES;
